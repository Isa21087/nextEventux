...
<!-- Enumere solo los cambios relevantes para revisar este PR. -->

## Validación y pruebas

<!-- Indique los comandos, escenarios y resultados. No escriba únicamente "funciona". -->

| Prueba o escenario | Resultado |
| --- | --- |
|  |  |
...
- SRS o caso de uso: No aplica / Describir
...
- [ ] Agregué o actualicé pruebas cuando cambié una regla de negocio.
- [ ] Revisé que el cambio cumpla los criterios de aceptación del Issue.
- [ ] Actualicé la documentación técnica afectada.
- [ ] Avisé a los responsables si el cambio afecta otros módulos.
- [ ] El Issue y el Control de Alcance reflejarán el estado real después de la fusión.
